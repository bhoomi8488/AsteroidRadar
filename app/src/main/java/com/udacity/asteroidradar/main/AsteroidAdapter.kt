...
class AsteroidAdapter( val onClickListener: OnClickListener ) :
    ListAdapter<Asteroid, AsteroidAdapter.MarsPropertyViewHolder>(DiffCallback) {
    /**
     * The MarsPropertyViewHolder constructor takes the binding variable from the associated
     * GridViewItem, which nicely gives it access to the full [MarsProperty] information.
     */
    class MarsPropertyViewHolder(private var binding: AstoridListBinding):
        RecyclerView.ViewHolder(binding.root) {
        fun bind(marsProperty: Asteroid) {
            println("kkk===$marsProperty")
    ...
    override fun onCreateViewHolder(parent: ViewGroup,
        ...
        return MarsPropertyViewHolder(AstoridListBinding.inflate(LayoutInflater.from(parent.context)))
    }
